...
4. Dispatch `reviewer`. If it returns CHANGES REQUIRED, loop back to the relevant dev agent — max 3 loops total. If still not resolved after 3, stop and report to the user instead of looping further.
5. Finish with a summary: **designed / changed / tested (results) / reviewed.**
